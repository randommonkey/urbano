...
![Qué nos dicen los datos](assets/02/quenosdicenlosdatos.PNG)
...
De una u otra manera, sentimos que la ciudad donde vivimos refleja nuestra “casa”. Cada recorrido urbano que hacemos diariamente por plazas, aceras, calles, portales, escaleras, universidades, avenidas...entre otras, condiciona nuestra percepción y el aprecio que tenemos de ella. Cada lugar que recorremos tiene su propio ambiente  y su propio sello, a veces más público, otras veces más íntimo. El espacio público de la ciudad es continuo, la arquitectura le da vida a la ciudad y marca recorridos, formas….comprende todo a nuestro alrededor, se apropia de las fachadas, de las ruinas, de la perspectiva, del paisaje.

Por eso, la intervención del espacio público a partir de visualizaciones callejeras es seguramente la acción más visible e influyente que podemos proponer. Es por esto que no puede ser considerado como algo ajeno como parte del espacio residual, sino que debe concebirse desde una acción positiva, reconociendo su función excepcional y su influencia representativa de la ciudad y del espacio público. 
