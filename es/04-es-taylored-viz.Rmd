...
Las visualizaciones a la medida varían mucho dependiendo de los tamaños de los objetos o espacios a intervenir. Categorizamos estos tipos de intervenciones en 3 tipos dependiende desde qué distancia se pueden apreciar las visualizaciones para un humano cualquiera.
...
```{r, echo = FALSE, message=FALSE, warning=FALSE,fig.cap='Doris Salcedo https://www.theguardian.com/world/2016/oct/12/colombia-war-art-project-bogota-doris-salcedo'}
...
```{r, echo = FALSE, message=FALSE, warning=FALSE,fig.cap='https://www.instagram.com/p/BLFCFloDnjF/'}
